...
Footer: CONFIDENTIAL — For Internal Use Only (if EB)
```
...
| Context | Emojis |
|---------|--------|
| **Section Headers** | 📋 Meeting Details, 🎯 Target Outcomes, ✅ Success Criteria, 🔄 Information Exchange, 🛡️ Objections, 📅 Agenda, ➡️ Next Steps, 👥 Key Stakeholders, 📊 Opportunity Snapshot, 🗺️ Engagement Roadmap, 📝 What Changed, 🔍 Meeting Insights |
